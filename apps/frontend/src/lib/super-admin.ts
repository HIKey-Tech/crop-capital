...
export const featureLabels: Array<{
  ...
  { key: 'adminMarketplace', label: 'Admin Marketplace' },
...
export const getTenantAccessUrls = (tenant: TenantSummary, origin: string) => {
  ...
  return {
    ...
    marketplaceUrl: `${preferredBaseUrl}/marketplace`,
    marketplaceOrdersUrl: `${preferredBaseUrl}/marketplace/orders`,
    adminMarketplaceUrl: `${preferredBaseUrl}/admin/marketplace`,
    adminMarketplaceOrdersUrl: `${preferredBaseUrl}/admin/marketplace/orders`,
