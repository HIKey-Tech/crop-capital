      ...
      <div className="pt-28 pb-32">
        <div className="bg-secondary relative overflow-hidden py-20 lg:py-28 mb-0">
          ...
          <div className="premium-container relative z-10">
            ...
            <h1 className="text-display text-[clamp(3rem,6vw,7rem)] text-secondary-foreground mb-4">Terms of Access</h1>
        ...
        <div className="premium-container max-w-4xl mx-auto pt-16">
          <div className="mb-12 p-8 border border-border bg-primary/[0.025] flex gap-5">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed font-medium">
              These Terms of Access govern your use of the {tenant.displayName} investment platform. Agricultural investments involve risk — please review these terms and our Disclosures carefully before committing capital.
            </p>
          </div>
