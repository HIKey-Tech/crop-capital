        ...
        <div className="bg-primary relative overflow-hidden py-20 lg:py-28 mb-0">
          ...
          <div className="premium-container relative z-10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.5em] text-white/50">Legal Document</span>
            </div>
            <h1 className="text-display text-[clamp(3rem,6vw,7rem)] text-white mb-4">Privacy Policy</h1>
            <p className="text-base font-bold text-white/45 uppercase tracking-[0.25em]">Last updated: March 2026</p>
          </div>
        </div>
        ...
        <div className="premium-container max-w-4xl mx-auto pt-16">
          <div className="mb-12 p-8 border border-border bg-primary/[0.025] flex gap-5">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed font-medium">
              {tenant.displayName} is committed to protecting the privacy of all investors and their personal data. This policy explains what information we collect, how we use it, and your rights regarding your data.
            </p>
          </div>
