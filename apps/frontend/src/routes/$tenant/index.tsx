    ...
    >
      <div className="premium-container flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          ...
          >
            <span className="text-[11px] font-black uppercase tracking-[0.35em] text-foreground hover:text-primary transition-colors cursor-pointer">
              Login
            </span>
          </Link>
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden dot-grid">
      ...
      <div
        ...
        style={{ width: 'clamp(38%, 44vw, 600px)' }}
      >
        <img
          src={farmPalmTrees}
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to right, hsl(40 20% 98%) 0%, hsl(40 20% 98% / 0.5) 28%, transparent 60%)',
          }}
        />
        ...
        {/* Floating AUM card */}
        <div
          className="absolute bottom-16 left-0 -translate-x-1/3 bg-secondary text-secondary-foreground p-8 shadow-2xl hidden lg:block border-l-4 border-primary"
          style={{
            opacity: mounted ? 1 : 0,
            transform: mounted ? 'translateX(-33%)' : 'translateX(-15%)',
            transition:
              'opacity 1s ease 1.4s, transform 1s cubic-bezier(0.19,1,0.22,1) 1.4s',
          }}
        >
          <div className="text-4xl font-black text-primary-foreground mb-1">
            $11.8M
          </div>
          <div className="text-[10px] font-black uppercase tracking-[0.32em] text-secondary-foreground/50">
        ...
        <div className="w-full lg:max-w-[62%] py-24 sm:py-32 lg:py-44">
          ...
          >
            ...
            <span className="text-[11px] font-black uppercase tracking-[0.5em] text-primary">
              Institutional Grade Agriculture
            </span>
          </div>
          ...
          <h1 className="mb-9">
            {[
              ...
              <span key={i} className="block mb-[-0.06em]">
                <span
                  className={cn(
                    'block text-[clamp(4rem,8vw,9rem)]',
                    line.style,
                  )}
                  style={{
                    animation: mounted
          ...
          >
            <p className="text-xl lg:text-2xl text-muted-foreground mb-10 max-w-md leading-relaxed font-medium">
              Direct access to high-yield, insured agricultural assets managed
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 sm:gap-8">
              ...
              <button className="flex items-center gap-3 group cursor-pointer">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.3em] text-muted-foreground group-hover:text-primary transition-colors">
                  Watch Overview
                </span>
              </button>
            </div>
  ...
  const metrics = [
    {
      ...
      desc: 'Net of fees, last 3 cycles',
    },
    {
      value: 2500,
      suffix: '',
      label: 'Capital Partners',
      desc: 'Institutional & private investors',
    },
    {
      value: 11,
      suffix: '.8M',
      ...
      prefix: '$',
      desc: 'Across active farm portfolios',
    },
  ]
  return (
          ...
          {metrics.map((m, i) => (
            ...
            >
              <FadeIn delay={i * 120}>
                ...
                <div className="text-base font-black text-secondary-foreground uppercase tracking-tight mb-2">
                  {m.label}
                </div>
                <div className="text-[11px] font-bold uppercase tracking-[0.28em] text-secondary-foreground/40">
                  {m.desc}
                </div>
              </FadeIn>
            </div>
  ...
  return (
    <div className="group relative overflow-hidden bg-background feature-card cursor-pointer">
      <div
        ...
        style={{ aspectRatio: tall ? '4/5' : '4/6' }}
      >
        <img
          src={farm.img}
          alt={farm.name}
          ...
          onMouseEnter={(e) => {
            ;(e.currentTarget as HTMLImageElement).style.filter =
              'saturate(0.85) brightness(0.88)'
          }}
          onMouseLeave={(e) => {
            ;(e.currentTarget as HTMLImageElement).style.filter =
              'saturate(0.35) brightness(0.8)'
          }}
        />
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 transform transition-all duration-500 group-hover:-translate-y-1">
        ...
        <h3 className="text-display text-[clamp(1.3rem,2.5vw,2rem)] text-foreground mb-5 group-hover:text-primary transition-colors duration-300">
          {farm.name}
        </h3>
...
function PortfolioSection({ tenantParam }: { tenantParam: string }) {
  const farms = [
    {
      name: 'Owerri Cassava Cluster',
      location: 'Eastern Region',
      roi: '18.5%',
      img: farmCassava,
    },
    {
      name: 'Plateau Wheat Valley',
      location: 'Northern Highlands',
      roi: '22.0%',
      img: farmWheat,
    },
    {
      name: 'Kano Palm Paddies',
      location: 'Central Basin',
      roi: '15.8%',
      img: farmPalmTrees,
    },
  ]
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-10">
          <FadeIn className="max-w-xl">
            ...
            <h2 className="text-display text-[clamp(3.2rem,6vw,7rem)] text-foreground">
              Portfolio
              <br />
              <span className="italic-serif text-primary">Spotlights.</span>
            </h2>
          </FadeIn>
          <FadeIn delay={200}>
            <Link to="/$tenant/farms" params={{ tenant: tenantParam }}>
  ...
  const pillars = [
    {
      ...
      desc: 'Rigorous 5-step vetting including soil analytics, climate modeling, and crop-cycle forecasting.',
    },
    {
      icon: Shield,
      title: 'Risk Mitigation',
      desc: 'Comprehensive agricultural insurance covering yield loss, weather events, and commodity price shifts.',
    },
    {
      icon: Clock,
      title: 'Real-Time Reporting',
      desc: 'Daily growth telemetry, weekly drone surveillance footage, and live portfolio dashboards.',
    },
  ]
  return (
    <section
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start lg:items-center">
          <FadeIn direction="left">
            ...
            <h2 className="text-display text-[clamp(3rem,5.5vw,6.5rem)] text-white mb-14 text-balance">
              A data-driven{' '}
              <span className="italic-serif text-white/60">growth engine.</span>
            </h2>
              ...
              {pillars.map((p, i) => {
                ...
                return (
                  <div key={i} className="flex gap-7 group">
                    <div className="w-12 h-12 shrink-0 border border-white/15 flex items-center justify-center text-white/70 transition-all duration-300 group-hover:bg-white group-hover:text-primary group-hover:border-white">
  ...
  const steps = [
    {
      ...
      desc: 'Sign up and complete our streamlined KYC verification process. Takes under 10 minutes.',
    },
    {
      number: '02',
      icon: TrendingUp,
      title: 'Browse Opportunities',
      desc: 'Explore our curated portfolio of high-yield agricultural assets across regions.',
    },
    {
      number: '03',
      icon: FileText,
      title: 'Invest & Monitor',
      desc: 'Fund your allocation and track real-time performance through your investor dashboard.',
    },
    {
      number: '04',
      icon: CheckCircle2,
      ...
      <div className="premium-container relative z-10">
        <FadeIn className="mb-24">
          ...
          <h2 className="text-display text-[clamp(3.2rem,6vw,7rem)] text-foreground max-w-2xl">
            Invest in{' '}
            <span className="italic-serif text-primary">Four Steps.</span>
          </h2>
        </FadeIn>
  ...
  const guarantees = [
    {
      ...
      desc: 'Every farm investment is backed by agricultural insurance covering yield loss, extreme weather, and pest damage.',
    },
    {
      icon: FileText,
      title: 'Regulatory Compliance',
      desc: 'Full KYC/AML compliance across all jurisdictions. Your investment is protected by law.',
    },
    {
      icon: TrendingUp,
      title: 'Transparent Reporting',
      desc: 'Monthly performance statements, quarterly audits, and real-time dashboard access. No hidden information.',
    },
    {
      icon: Clock,
      title: 'Experienced Operators',
      desc: 'Farms managed by agricultural professionals with 10+ years of on-ground experience in each region.',
    },
  ]
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-32 items-start">
          <FadeIn direction="left">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed font-medium mb-14 max-w-lg">
              Agricultural investment carries inherent risk. We've built
              comprehensive safeguards at every layer to protect your allocation
              and maximise predictable returns.
            </p>
            <Link to="/$tenant/auth" params={{ tenant: tenantParam }}>
              <Button
                size="lg"
                className="btn-primary-gradient h-14 px-10 text-sm font-black uppercase tracking-[0.18em] group"
              >
                Start Investing
                <ArrowRight className="w-5 h-5 ml-3 group-hover:translate-x-1 transition-transform" />
              </Button>
            ...
            <div className="grid grid-cols-1 gap-0 border border-border">
              {guarantees.map((g, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="flex gap-6 p-8 border-b border-border last:border-b-0 group hover:bg-primary/2.5 transition-colors duration-300"
                  >
                    <div className="w-10 h-10 shrink-0 bg-primary/10 text-primary flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300">
                      <Icon className="w-5 h-5" />
                    </div>
                    <div>
      ...
      <div className="premium-container">
        <FadeIn className="mb-16">
          ...
          <h2 className="text-display text-[clamp(3.2rem,6vw,7rem)] text-foreground max-w-xl">
            What Partners{' '}
            <span className="italic-serif text-primary">Are Saying.</span>
          </h2>
        </FadeIn>
          ...
          {testimonials.map((t, i) => (
            ...
            >
              <div className="feature-card bg-background p-8 sm:p-12 lg:p-16 h-full flex flex-col">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl text-foreground leading-relaxed mb-10 flex-1 font-medium italic">
                  {t.text}
                </p>
                <div className="flex items-center gap-5">
                  <div className="h-px bg-primary w-10" />
...
function CTASection({ tenantParam }: { tenantParam: string }) {
  return (
    <section className="section-spacing relative overflow-hidden">
      <div className="absolute inset-0 dot-grid opacity-40" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-100 bg-primary/4 rounded-full blur-[120px]" />
      <div className="premium-container relative z-10 text-center">
        <FadeIn>
          <div className="flex items-center justify-center gap-4 mb-10">
            <div className="h-px bg-primary w-10" />
            <span className="text-[11px] font-black uppercase tracking-[0.5em] text-primary">
              Limited Allocations Open
            </span>
            <div className="h-px bg-primary w-10" />
          </div>
          <h2 className="text-display text-[clamp(3rem,8vw,9rem)] text-foreground mb-8 text-balance">
            Secure Your
            <br />
            <span className="italic-serif text-primary">Allocation.</span>
          </h2>
          <p className="text-xl lg:text-2xl text-muted-foreground mb-14 max-w-2xl mx-auto font-medium leading-relaxed">
            Limited high-yield cycles are now open for institutional and private
            capital. Join the new era of agricultural finance.
          </p>
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
            <Link to="/$tenant/auth" params={{ tenant: tenantParam }}>
              <Button
                size="lg"
                className="btn-primary-gradient h-16 px-14 text-sm font-black uppercase tracking-[0.18em] group"
              >
            ...
            <a
              href="mailto:invest@cropcapital.com"
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 mt-16 pt-16 border-t border-border">
            {[
              ...
              <div
                key={s}
                className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.25em] text-muted-foreground/60"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-16 mb-16">
            <div className="sm:col-span-2 lg:col-span-6">
              <div className="flex items-center gap-3 mb-10">
                ...
                <div>
                  <div className="text-base font-black uppercase tracking-[0.2em]">
                    {tenant.displayName}
                  </div>
                  <div className="text-[9px] font-black uppercase tracking-[0.3em] text-primary-foreground/50">
                    Agricultural Finance
                  </div>
                </div>
              </div>
              <p className="text-secondary-foreground/50 text-lg leading-relaxed max-w-md font-medium mb-12">
                Pioneering the synthesis of institutional finance and
                sustainable agricultural production across the African
                continent.
              </p>
              <div className="flex gap-10">
                {['LinkedIn', 'Twitter'].map((s) => (
                  <a
                    key={s}
                    href="#"
                    className="text-[11px] font-black uppercase tracking-[0.3em] text-secondary-foreground/35 hover:text-primary-foreground transition-colors"
                  >
                    {s}
                  </a>
                ))}
            ...
            <div className="lg:col-span-3">
              <h4 className="text-[10px] font-black uppercase tracking-[0.45em] text-primary-foreground/50 mb-8">
                Investments
              </h4>
