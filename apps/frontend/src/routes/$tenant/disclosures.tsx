      ...
      <div className="pt-28 pb-32">
        <div className="bg-secondary relative overflow-hidden py-20 lg:py-28 mb-0">
          ...
          <div className="premium-container relative z-10">
            ...
            <h1 className="text-display text-[clamp(3rem,6vw,7rem)] text-secondary-foreground mb-4">Disclosures</h1>
        ...
        <div className="premium-container max-w-4xl mx-auto pt-16">
          <div className="mb-12 p-8 border border-border bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-900/40 flex gap-5">
            <AlertTriangle className="w-6 h-6 text-amber-600 dark:text-amber-500 flex-shrink-0 mt-0.5" />
            <p className="text-lg text-foreground/80 leading-relaxed font-medium">
              <strong className="text-foreground">Important:</strong> Agricultural investments carry significant risks including the potential loss of invested capital. Please read these disclosures carefully before making any investment decision. These disclosures form part of the Terms of Access for this platform.
            </p>
          </div>
          ...
          <div className="mt-16 p-8 border border-border bg-muted/40">
            <p className="text-sm text-muted-foreground leading-relaxed font-medium">
              These disclosures are provided for informational purposes and do not constitute financial advice. For specific questions regarding investment suitability, please consult an independent financial adviser. Contact{' '}
              <a href={`mailto:${tenant.supportEmail || 'support@cropcapital.com'}`} className="text-primary hover:underline font-black">
          ...
          <div className="mt-16 pt-16 border-t border-border flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
            ...
            <div className="flex gap-8">
              ...
              <Link to="/$tenant/support" params={{ tenant: tenantParam }} className="text-[11px] font-black uppercase tracking-[0.3em] text-muted-foreground hover:text-primary transition-colors">Support</Link>
            </div>
          </div>
        </div>
      </div>
