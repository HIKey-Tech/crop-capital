...
export const Route = createFileRoute('/$tenant/_authenticated/transactions/')({
...
const getColumns = (tenant: string): Array<ColumnDef<Transaction>> => [
  {
    accessorKey: 'id',
    header: 'Ref ID',
    cell: ({ getValue }) => (
    ...
    cell: ({ row }) => {
      ...
      return (
        <Link
          ...
          params={{ tenant, id: tx.investmentId }}
